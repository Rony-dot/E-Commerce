                            ...
                            <ul>
                                ...
                                <li class="menu-item menu-item-has-children parent">
                                    ...
                                    <ul class="submenu curency">
										...
										<li class="menu-item">
                                            <a onclick="event.preventDefault(); document.getElementById('log-out-admin-form').submit()" title="Logout"  href="#">Log out</a>
                                        </li>
										<form id="log-out-admin-form" action="{{route('logout')}}" method="POST">
											@csrf 
										</form>
                                    </ul>
                                </li>
                                ...
                                <li class="menu-item menu-item-has-children parent">
                                    ...
                                    <ul class="submenu curency">
										...
										<li class="menu-item">
                                            <a onclick="event.preventDefault(); document.getElementById('log-out-user-form').submit()" title="Logout"  href="#">Log out</a>
                                        </li>
										<form id="log-out-user-form" action="{{route('logout')}}" method="POST">
											@csrf 
										</form>
                                    </ul>
                                </li>
